...
namespace Projeto_FPAA
{
    internal class Menu
    {
        ...
        public void Corpo()
        {
            ...
            Console.WriteLine("4. Executar Algoritmo de Kruskal (encontrar menor custo total)");
            Console.WriteLine("5. Exibir último resultado da Árvore Geradora Mínima");
            Console.WriteLine();
        }
